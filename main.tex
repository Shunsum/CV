%%%%%%%%%%%%%%%%%
% This is an example CV created using altacv.cls (v1.1.4, 27 July 2018) written by Shunsum Lau (shunsumlau@qq.com), based on the
...
\cvevent{MSc Thesis}{Analytical Electromagnetic Response Theory of HF/KS Energy: A Unified Treatment from Nonrelativistic to Relativistic Frameworks}{}{}
\begin{itemize}
...
\cvevent{BSc Thesis}{DFT Analysis of the Conversion Mechanism from Dihydroartemisinic Acid to Artemisinin}{}{}
\begin{itemize}
